...
public class GraphCore {
     ...
     * 在有向图中，关联一对顶点的有向边如果多余1条，并且它们的方向相反，则称这些边为平行边
     ...
     * 连通分量：无向图的极大连通分量，也就是一个无向图，能分为几个最大的连通图，连通图只有1个连通分量，就是它自身，非连通的无向图有多个连通分量
     * 强连通图：如果有向图G中任意2个顶点都是连通的，则称G为强连通图
     * 强连通分量：有向图的极大强连通分量，强连通图只有1个强连通分量，就是它自身，非强连通的有向图有多个强连通分量
     */
}
