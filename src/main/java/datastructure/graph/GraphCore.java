...
public class GraphCore {
    ...
    /**
     * 图的遍历：
     * 广度优先搜索：BFS，类似二叉树的层序遍历，从一个顶点开始，它是第一层，直连一条边到达的所有顶点，就是第二层，第二层的所有顶点直连到达的所有顶点，就是第三层，以此类推，直到最后全部顶点遍历完毕
     *
     * 深度优先搜索：DFS，类似二叉树的前序遍历，从一个顶点开始，向一条边有深走多深，直到再没有路径，回退到路径上一顶点，再换另外一条边有多深走多深，以此类推，直到最后全部路径都遍历完（回溯）
     *
     */
}
