...
public class TreeCore {
     ...
     * 并查集：
     *
     * 是一种树状结构，也叫作 不相交集合，可以用来查询两个元素是否在一起
     *
     * 一开始所有的元素都独占一个集合，它们分别是各个集合的根节点，根节点代表这个集合      （这里的集合，不是指Set这种数据结构，是广义的数据集合，数据集）
     * 集合的元素都有父节点，父节点指向自己，则是根节点  （也代表它没父节点）
